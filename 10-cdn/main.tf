resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              = "web-${var.environment}.${var.zone_name}" # web-dev-hemamnth78s.online
  ...
  aliases = ["web-${var.common_tags.Component}.${var.zone_name}"] # web-cdn-hemamnth78s.online
